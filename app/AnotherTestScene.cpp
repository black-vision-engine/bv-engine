...
model::BasicNode *          GreenRect()
{
    ...
    auto colorPlugin = PluginsFactory::CreateSimpleColorPlugin( transformPlugin, PluginsFactory::CreateParameter( "color", PluginsFactory::CreateConstValue( glm::vec4( 0.f, 1.f, 0.f, 1.f ) ) ) );
