...
private:
    ...
    void     GetAssetDescriptor      ( JsonSerializeObject & ser, const std::string & request, int eventID );
    void     GetAssetThumbnail       ( JsonSerializeObject & ser, const std::string & request, int eventID );
