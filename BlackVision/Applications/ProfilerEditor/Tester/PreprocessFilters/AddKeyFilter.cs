...
namespace ProfilerEditor.Tester.PreprocessFilters
{
    public class AddKeyFilter
    {
        ...
        private static int          RemoveResponses (   ObservableCollection<Event> testEvents,
                                                        ObservableCollection<Event> referenceEvents,
                                                        int startRmRange,
                                                        int endRmRange,
                                                        int referenceCounter )
        ...
        private static void         RemoveTestEvents(   ObservableCollection<Event> testEvents,
                                                        ObservableCollection<Event> referenceEvents,
                                                        int startRmRange,
                                                        int endRmRange )
        {
            var numRemove = endRmRange - startRmRange - 2;
        ...
        private static int          FindReferenceEvent  ( Event curEvent, ObservableCollection<Event> referenceEvents, int referenceCounter )
        {
