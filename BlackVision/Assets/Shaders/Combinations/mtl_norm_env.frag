...
vec3 computeEnvironment			( vec3 viewDir, vec3 normal )
{
	...
	//vec3 reflectionVec = reflectionTangentSpace;
	...
	//vec3 texColor = reflectionTangentSpace;
	//vec3 texColor = vec3( uvCoord.x, uvCoord.y, 0.0 );
	//vec3 texColor = vec3( -tangentToWorldSpace[0].x, -tangentToWorldSpace[0].y, -tangentToWorldSpace[0].z );
	//vec3 texColor = reflectionVec;
	//vec3 texColor = viewDir;
	//vec3 texColor = normal;
