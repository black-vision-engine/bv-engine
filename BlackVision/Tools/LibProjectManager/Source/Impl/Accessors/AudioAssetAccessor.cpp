...
// ********************************
//
AudioAssetAccessorConstPtr  AudioAssetAccessor::Create             ( const Path & rootPath, const StringVector & fileExts )
{
	return AudioAssetAccessorConstPtr( new AudioAssetAccessor( rootPath, fileExts ) );
}

// ***********************
//
                            AudioAssetAccessor::AudioAssetAccessor    ( const Path & rootPath, const StringVector & fileExts )
	: m_rootPath( rootPath )
	, m_fileExts( fileExts )
{
...
// ***********************
//
AudioAssetAccessor::~AudioAssetAccessor()
{}


// ********************************
//
AssetDescConstPtr	        AudioAssetAccessor::GetAssetDesc	    ( const Path & path ) const
{
...
// ********************************
//
void			 	        AudioAssetAccessor::AddAsset		    ( const Path & internalPath, const AssetDescConstPtr & assetDesc ) const
{
...
// ********************************
//
void			 	AudioAssetAccessor::RemoveAsset	( const Path & internalPath ) const
{
...
// ********************************
//
void			 	AudioAssetAccessor::RenameAsset	( const Path & oldPath, const Path & newPath ) const
{
...
// ********************************
//
void			 	AudioAssetAccessor::ExportAsset	( const Path & expAssetFilePath, const Path & internalPath) const
{
...
// ********************************
//
void			 	AudioAssetAccessor::ExportAsset	( std::ostream & out, const Path & internalPath) const
{
...
// ********************************
//
void			 	AudioAssetAccessor::ImportAsset	( const Path & impAssetFile, const Path & importToPath ) const
{
...
// ********************************
//
void				AudioAssetAccessor::ImportAsset	( std::istream & in, const Path &  importToPath ) const
{
...
// ********************************
//
void			 	AudioAssetAccessor::ExportAll		( std::ostream & out ) const
{
...
// ********************************
//
void			 	AudioAssetAccessor::ExportAll		( const Path & expAssetFilePath ) const
{
	auto expFile = File::Open( expAssetFilePath.Str(), File::OpenMode::FOMWriteAppend );
...
// ********************************
//
PathVec              AudioAssetAccessor::ListAll		( const Path & path, bool recursive ) const
{
	PathVec ret;
...
// ********************************
//
PathVec	            AudioAssetAccessor::ListAllUnique	( const Path & path ) const
{
...
// ********************************
//
UInt64              AudioAssetAccessor::GetAssetSizeInBytes ( const Path & path ) const
{
