...
public:
    ...
    NSamplerEntry ();
    NSamplerEntry ( const std::string & samplerName, TextureWrappingMode wrapX, TextureWrappingMode wrapY, TextureFilteringMode filteringMode );
...
typedef std::vector< NSamplerEntry > NSamplerEntryVec;
