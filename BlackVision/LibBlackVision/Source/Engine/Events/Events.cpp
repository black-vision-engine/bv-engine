...
std::pair< RenderingModeEvent::Command, const char* > RenderingModeEventCommandMapping[] = 
{
    std::make_pair( RenderingModeEvent::Command::ScreenShot, "ScreenShot" )
    , std::make_pair( RenderingModeEvent::Command::RenderOffscreen, "RenderOffscreen" ) 
    , std::make_pair( RenderingModeEvent::Command::Fail, SerializationHelper::EMPTY_STRING )      // default
};

template<> RenderingModeEvent::Command  String2T    ( const std::string& s, const RenderingModeEvent::Command& defaultVal )     { return String2Enum( RenderingModeEventCommandMapping, s, defaultVal ); }
template<> std::string                  T2String    ( const RenderingModeEvent::Command & t )                                   { return Enum2String( RenderingModeEventCommandMapping, t ); }
...
IEventPtr                RenderingModeEvent::Create          ( IDeserializer& deser )
{
    if( deser.GetAttribute( SerializationHelper::EVENT_TYPE_STRING ) == m_sEventName )
    {
        ...
        newEvent->RenderingCommand      = SerializationHelper::String2T<RenderingModeEvent::Command>( deser.GetAttribute( SerializationHelper::COMMAND_STRING ), RenderingModeEvent::Command::Fail );
