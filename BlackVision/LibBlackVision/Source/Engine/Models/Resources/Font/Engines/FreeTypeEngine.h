...
public:
	virtual TextAtlasConstPtr	CreateAtlas( SizeType padding, const std::wstring & wcharsSet )						override;
	virtual TextAtlasConstPtr	CreateAtlas( SizeType padding, SizeType outline, const std::wstring & wcharsSet )	override;
