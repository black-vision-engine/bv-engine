...
ser.EnterChild( "renderer_context" );
    ...
    SerializationHelper::SerializeAttribute( ser, alphaCtx->srcBlendMode, "srcBlendMode" );
    SerializationHelper::SerializeAttribute( ser, alphaCtx->dstBlendMode, "dstBlendMode" );
