...
public:
    ...
    explicit SimpleVertexShaderPD();
};


// ***************************** PLUGIN ********************************** 
class SimpleVertexShader : public BasePlugin< IPlugin, SimpleVertexShaderPluginPD >
{
private:
...
public:
    ...
    explicit                                SimpleVertexShader          ( const IPlugin * prev, const std::string& shaderPath );
                                            ~SimpleVertexShader         ();
