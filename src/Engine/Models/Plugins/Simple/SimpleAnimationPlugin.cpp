...
// *************************************
//
SimpleAnimationPlugin::SimpleAnimationPlugin                    ( IPluginConstPtr prev, const std::vector< std::string > & texturesFilesNames, const ParamFloat & frameCounter, model::RendererContext * ctx, TextureAttachmentMode mode )
