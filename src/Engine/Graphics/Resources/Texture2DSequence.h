...
class Texture2DSequence : public TextureAnimatedSequence
{
private:
...
public:
                                    ...
                                    Texture2DSequence   ( TextureFormat format, TextureType type, int width, int height );
    virtual                         ~Texture2DSequence  ();
